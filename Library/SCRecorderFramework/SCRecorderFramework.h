...
// In this header, you should import all the public headers of your framework using statements like #import <SCRecorderFramework/PublicHeader.h>

#import <SCRecorder/SCRecorderHeader.h>
